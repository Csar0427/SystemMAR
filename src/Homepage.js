  ...
  return (
    <div className="homepage">
      ...
      <div className="restaurant-info">
        <p>
          Although we offer a wide variety of hot and iced drinks, we also
          provide savory and sweet food options. So whether you're stopping for
          your morning coffee, lunch, or an afternoon snack, we've got you
          covered!!
        </p>
        <p>
          <FontAwesomeIcon icon={faMapMarkerAlt} /> Location: Novaliches Proper,
          Philippines
        </p>
        <p>
        ...
        <p>
          ...
          <a
            href="https://travelmugcafeph.com/"
            target="_blank"
            rel="noopener noreferrer"
            className="link-no-underline link-no-color"
          >
            https://travelmugcafeph.com/
          </a>
        </p>
